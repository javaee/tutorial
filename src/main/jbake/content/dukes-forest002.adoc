...
and three subprojects. link:#GLNVM[Figure 60-1] shows the architecture
...
link:#CIHCHCAA[Figure 60-2] shows how the web applications and the web
service interact.
...
As illustrated in link:#CIHCHCAA[Figure 60-2], the customer interacts
...
schema shown in link:#GLNXD[Figure 60-3] and is also used as a base for
