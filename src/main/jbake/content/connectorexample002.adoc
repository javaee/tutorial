...
link:#CHDHADIG[Figure 54-1] and consists of the following modules:
...
consists of the classes listed in link:#CHDCHJAC[Table 54-1].

[[sthref242]][[CHDCHJAC]]

Table 54-1 Classes and Interfaces in the javaeetutorial.trading.rar.api
Package
...
shown in link:#CHDIGAJE[Figure 54-2].
