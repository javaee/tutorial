...
link:#BNCDZ[Figure 46-2] illustrates the way these parts interact.
...
PTP messaging, illustrated in link:#BNCEC[Figure 46-3], has the
...
of consumers (or none). link:#BNCEE[Figure 46-4] illustrates pub/sub
messaging.
