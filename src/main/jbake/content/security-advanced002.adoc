...
* Certificate-based (see link:#GLIFJ[Figure 51-1])
* User name/password-based (see link:#GLIGQ[Figure 51-2])
...
link:#GLIFJ[Figure 51-1] shows what occurs during certificate-based
mutual authentication.
...
link:#GLIGQ[Figure 51-2] shows what occurs during user
