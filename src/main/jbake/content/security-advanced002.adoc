...
using the `HttpAuthenticationMechanism`. See link:security-api002#overview-of-the-http-auth-mech-int[Overview of the HTTP Authentication Mechanism Interface]. 
[[GLIEL]]
