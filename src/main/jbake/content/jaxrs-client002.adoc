...
using JAX-RS resources, as explained in link:jaxrs003.html#GJVBC[Chapter
30, "The rsvp Example Application"]. The web application uses the Client
...
link:jaxrs-advanced008.html#GKOIB[Chapter 32, "The customer Example
