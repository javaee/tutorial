...
In Java SE 8, JAX-WS provides the functionality for "big" web services. Big web services use XML messages that follow
...
RESTful web services are discussed in link:jaxrs.html#GIEPU[Chapter 30,
