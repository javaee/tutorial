...
The CDI 2.0 specification defines the following Configurators interface, which is available to CDI applications in matching container life cycle events:
