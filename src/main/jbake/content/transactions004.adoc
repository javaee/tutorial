...
link:#BNCIL[Figure 52-1] illustrates why controlling the scope is
...
link:#BNCIT[Table 52-1] summarizes the effects of the transaction
...
In the last column of link:#BNCIT[Table 52-1], the word "None" means
...
Table 52-1 Transaction Attributes and Scope
...
52-2] encapsulate the transaction attributes described earlier in this
section.

[[sthref236]][[GKCFD]]

Table 52-2 TransactionAttributeType Constants
