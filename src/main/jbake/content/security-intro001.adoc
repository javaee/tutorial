...
application URL. This action is shown in link:#BNBWN[Figure 48-1].
...
is validated by the web server, as shown in link:#BNBWP[Figure 48-2].
...
link:#BNBWR[Figure 48-3] shows this process.
...
original URL request, as shown in link:#BNBWT[Figure 48-4].
...
48-5]. The association is implemented as two related security contexts:
