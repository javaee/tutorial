...
names defined in GlassFish Server. By default, group principal names are mapped
to roles of the same name. This principal-to-role mapping is set by default
in the GlassFish Server Administration Console. All the tutorial security
