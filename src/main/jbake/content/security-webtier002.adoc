...
link:security-advanced.html#GJJWX[Chapter 51, "Java EE Security: Advanced
Topics"].
...
link:#BNCBP[Figure 49-1] shows what happens when you specify HTTP basic
authentication.
...
link:#GEXFA[Figure 49-2] shows what happens when you specify form-based
authentication.
